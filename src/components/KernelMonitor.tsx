    ...
    <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-xl font-mono text-xs p-4 overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-10 duration-300">
      ...
      <div className="flex justify-between items-center border-b border-white/10 pb-4 mb-4">
        <div className="flex items-center gap-2">
            ...
            <span className="text-emerald-500 font-bold tracking-widest uppercase">ZenB Runtime // v3.4.1</span>
        </div>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <div className="flex justify-between mb-1">
                            ...
                            <span className="text-purple-400">{state.belief.rhythm_alignment.toFixed(2)}</span>
                        </div>
                        <div className="h-1 w-full bg-white/10 rounded-full overflow-hidden">
                            <div className="h-full bg-purple-500" style={{ width: `${state.belief.rhythm_alignment * 100}%` }} />
                        </div>
                    </div>
                </div>
